...
const ManagerProfile = () => {
  ...
  const [profileData, setProfileData] = useState({
    firstName: "Manager",
    lastName: "User",
    email: "manager@pawesomeretreat.com",
    ...
    bio: "Experienced manager with expertise in team leadership, operations management, and strategic planning. Committed to excellence and continuous improvement.",
