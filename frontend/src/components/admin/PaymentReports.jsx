...
const PaymentReports = () => (
  <AdminLiveReport
    ...
    summaryBuilder={(summary) => [
      { id: "total-payments", label: "Total Payments", value: summary.total_payments, icon: "faReceipt", color: "primary" },
      { id: "total-amount", label: "Total Amount", value: summary.total_amount, currency: true, icon: "faMoneyBillWave", color: "success" },
      { id: "paid", label: "Paid/Verified", value: summary.paid, icon: "faCheckCircle", color: "success" },
      { id: "pending", label: "Pending", value: summary.pending, icon: "faClock", color: "warning" },
      { id: "rejected", label: "Rejected", value: summary.rejected, icon: "faTimesCircle", color: "danger" },
    ]}
    columns={[
