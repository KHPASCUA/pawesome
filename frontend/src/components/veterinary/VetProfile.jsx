...
const VetProfile = () => {
  ...
  const [profileData, setProfileData] = useState({
    ...
    bio: "Experienced veterinarian specializing in small animal medicine with 8 years of practice. Board certified in internal medicine and surgery.",
  ...
  return (
    <div className="vet-profile">
      ...
      <div className="profile-header">
        <h2>
          <FontAwesomeIcon icon={faUser} /> Veterinarian Profile
        </h2>
