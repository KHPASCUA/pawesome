...
const InventoryProfile = () => {
  ...
  const [profileData, setProfileData] = useState({
    firstName: "Inventory",
    lastName: "Manager",
    email: "inventory@pawesomeretreat.com",
    phone: "+1 (555) 456-7890",
    address: "654 Storage Warehouse",
    city: "Supply City",
    state: "SC",
    zipCode: "98765",
    country: "United States",
    bio: "Detail-oriented inventory manager with expertise in stock control, supply chain management, and inventory optimization. Focused on maintaining accurate inventory levels and efficient operations.",
